                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label pt-1" for="enable_drip_content"><?php echo get_phrase('Updated as'); ?></label>
                                                    <div class="col-md-10 pt-1">
                                                        ...
                                                        <div id="upcoming" class="custom-control custom-radio mb-1 d-none">
                                            ...
                                            <div class="col-xl-8 d-none">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <video id="player" height='200' width='300' class='mt-2 <?php if ($course_details['course_overview_provider'] != 'system' || !$course_details['video_url'] || get_video_extension($course_details['video_url'])=='unknown') echo 'd-none'; ?>' playsinline controls>
