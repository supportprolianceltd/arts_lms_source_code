        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form action="<?php echo site_url('admin/add_users_from_csv'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                            <label><?php echo get_phrase('upload_users_from_csv_file'); ?></label>
