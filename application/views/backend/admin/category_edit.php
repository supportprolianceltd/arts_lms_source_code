        ...
        <div class="col-lg-12">
          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control" id="about" name = "about" row=3 required><?php echo $category_details['about'];?></textarea>
            </div>
            ...
            <div class="form-group" id='booking-area'>
                ...
                <select class="form-control select2" data-toggle="select2" name="booking" id="booking">
                  <option value="0" <?php if((int)$category_details['booking']==0) echo 'selected';?>><?php echo get_phrase('normal'); ?></option>
                  <option value="1" <?php if((int)$category_details['booking']==1) echo 'selected';?>><?php echo get_phrase('open_for_live_classes'); ?></option>
                  <option value="-1" <?php if((int)$category_details['booking']==-1) echo 'selected';?>><?php echo get_phrase('closed_for_live_classes'); ?></option>
                </select>
