...
<div class="row">
    <div class="col-md-7" style="padding: 0;">
        ...
        <?php foreach($payment_gateways as $payment_gateway): ?>
            ...
            <?php /*if($payment_gateway['is_addon'] && !addon_status($payment_gateway['identifier']) || $payment_gateway['identifier'] == 'offline_payment') continue;*/if(!$payment_gateway['status']) continue; ?>
