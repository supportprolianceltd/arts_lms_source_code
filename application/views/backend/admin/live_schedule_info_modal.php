    ...
    echo <<<HTML
      ...
      <table class=''>
        ...
        <tr>
          ...
          <td class='text-left'><a target='_blank' href='$system_base_url/admin/user_profile/{$user['id']}'>{$user['first_name']} {$user['last_name']} ({$user['email']})</a></td>
        </tr>
        <tr class='$course_disp'>
          <td class='text-left'>Course:</td>
          <td class='text-left'><a href='$system_base_url/admin/course_form/course_edit/{$schedule['course_id']}'>{$course['title']}</a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class='text-left'><span class='rounded p-1 text-dark' style='display:inline-block;background:#FAFCFE;'>{$schedule['note']}</span></td>
        </tr>
        <tr>
