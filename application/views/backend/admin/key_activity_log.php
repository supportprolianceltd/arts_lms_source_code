        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if (has_permission('iqa')) : ?>
                    <a href="javascript:void(0)" onclick="showAjaxModal('<?php echo site_url('modal/popup/key_activity_log_add_modal');?>','Add key activity');" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_key_activity'); ?></a>
                <?php endif;?>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
        ...
        <div class="card">
            ...
            <div class="row justify-content-md-center">
                    <div class="col-12">
                        ...
                        <form class='justify-content-center' method=post  action="<?php echo site_url('admin/key_activity_log'); ?>">
                    ...
                    <div class='form-group col-md-4'>
                        <input type="text" name="activity" class="form-control" value='<?php echo $activity;?>' placeholder="<?php echo get_phrase('activity'); ?>">
                    </div>
                ...
                <h4 class="mb-3 header-title"><?php echo get_phrase('key_activities'); ?></h4>
                <div class="table-responsive mt-4">
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            <?php
                            foreach ($key_activity_log as $key => $activity_log) : ?>
                                <tr id='tr_<?php echo $key + 1; ?>'>
                                    ...
                                    <td><?php echo $activity_log['activity'];?></td>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="javascript:void(0)" onclick="showAjaxModal('<?php echo site_url('modal/popup/key_activity_log_info_modal/' . $activity_log['id']);?>','Key activity');"><?php echo get_phrase('info'); ?></a></li>
                                                <?php if (has_permission('iqa')) : ?>
                                                    <li><a class="dropdown-item" href="javascript:void(0)" onclick="showAjaxModal('<?php echo site_url('modal/popup/key_activity_log_edit_modal/' . $activity_log['id']);?>','Edit key activity');"><?php echo get_phrase('edit'); ?></a></li>
                                                    <li><a class="dropdown-item" href="#" onclick="ajax_confirm_modal('<?php echo site_url('admin/key_activity_log/delete_api/' . $activity_log['id']); ?>','tr_<?php echo $key + 1; ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                                <?php endif;?>
                                            </ul>
                                        </div>
                                    </td>
