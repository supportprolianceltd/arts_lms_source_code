...
<div class="form-group">
    ...
    <textarea name="text_description" class="form-control summer_note_ext_1 summer_note_ext_strip" id="text_description" rows="4"><?php echo htmlspecialchars_decode_($lesson_details['attachment']); ?></textarea>
</div>
