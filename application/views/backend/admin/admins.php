                                        ...
                                        <?php if (!is_root_admin($user['id'])) : ?>
                                            <div class="dropright dropright">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a target="_blank" class="dropdown-item" href="<?php echo site_url('admin/user_profile/' . $user['id']);?>"><?php echo get_phrase('profile');?></a></li>
                                                    <li><a class="dropdown-item" href="javascript:void(0);" onclick="showAjaxModal('<?php echo site_url('modal/popup/mail_user_modal/' . $user['id']);?>','send mail')"><?php echo get_phrase('mail');?></a></li>
