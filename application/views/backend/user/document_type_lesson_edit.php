<div class="form-group">
    ...
    <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required>
        ...
        <option value="other-pdf"    <?php if($lesson_details['attachment_type'] == 'pdf')    echo 'selected'; ?>><?php echo get_phrase('pdf_presentation'); ?></option>
        <option value="other-pdfs"    <?php if($lesson_details['attachment_type'] == 'pdfs')    echo 'selected'; ?>><?php echo get_phrase('pdf_file'); ?></option>
        <option value="other-doc"    <?php if($lesson_details['attachment_type'] == 'doc')    echo 'selected'; ?>><?php echo get_phrase('document_file'); ?></option>
        <!--
                <option value="other-ppt"    <?php if($lesson_details['attachment_type'] == 'ppt')    echo 'selected'; ?>><?php echo get_phrase('ppt_file'); ?></option>
