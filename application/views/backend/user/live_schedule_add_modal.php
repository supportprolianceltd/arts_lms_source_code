<div class="row">
	<div class="col-md-12">
      ...
      <div class="form-group">
          <label for="course_id"><?php echo get_phrase('course_to_schedule'); ?><span class="required">*</span> </label>
      ...
      <div class="form-group">
				...
				<input type="text" name="title" class="form-control" placeholder="<?php echo get_phrase('title_of_event'); ?>">
			</div>
