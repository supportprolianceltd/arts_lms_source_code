<?php if($question_type == 'multiple_choice' || $question_type == 'single_choice'): ?>
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="number" value="<?php if(isset($question_details)) echo $question_details['number_of_options']; ?>" oninput="appendOptions(this.value, '<?php echo $question_type; ?>')" class="form-control" name="number_of_options" id="number_of_options" data-validate="required" data-message-required="Value Required" min="0" step=1>
        </div>
    </div>
