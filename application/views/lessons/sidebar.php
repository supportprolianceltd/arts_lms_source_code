                    ...
                    <a href="<?php echo $lesson_url; ?>" class="d-flex align-items-baseline w-100 checkbox-box-a">
                      ...
                      <?php if($course_details['enable_drip_content']): ?>
                        ...
                        <?php else: ?>
                          ...
                          <?php if($is_lesson_completed && $lesson['lesson_type'] == 'video' || $is_lesson_completed && $lesson['lesson_type'] == 'quiz' || $is_lesson_completed && $lesson['lesson_type'] == 'audio' || $is_lesson_completed && 1): ?>
                          ...
                          <?php else: ?>
                            ...
                            <?php else: ?>
                              <i class="fas fa-file me-2" title="<?php echo get_phrase('Play Now'); ?>" data-bs-toggle="tooltip"></i>
