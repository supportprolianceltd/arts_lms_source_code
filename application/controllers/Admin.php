...
class Admin extends CI_Controller
{
    ...
    public function categories($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add') {
            ...
            if ($response) {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','categories','add_category','add_category',null,'crud_model',"data_added_successfully",'creates a new category','successful',['text'=>'attempts to create a new category']);
                $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
            } else {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','categories','add_category','add_category',null,'crud_model',"category_name_already_exists",'creates a new category','failed',['text'=>'attempts to create a new category']);
            ...
            if ($response) {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','categories','edit_category','edit_category',"$param2",'crud_model',"data_added_successfully",'edits an existing category','successful',['text'=>'attempts to modify existing category']);
                $this->session->set_flashdata('flash_message', get_phrase('data_added_successfully'));
            } else {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','categories','edit_category','edit_category',"$param2",'crud_model',"category_name_already_exists",'edits an existing category','failed',['text'=>'attempts to modify existing category']);
                $this->session->set_flashdata('error_message', get_phrase('category_name_already_exists'));
            }
            redirect(site_url('admin/categories'), 'refresh');
        } elseif ($param1 == "delete") {
            $this->crud_model->delete_category($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','categories','delete_category','delete_category',"$param2",'crud_model',"data_deleted",'deletes existing category','successful',['text'=>'attempts to delete category']);
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','categories','sub_category_image','delete_subcategory_image',"$param2",'crud_model',"data_deleted",'deletes existing sub category image','successful',['text'=>'attempts to delete sub category image']);
            $this->session->set_flashdata('flash_message', get_phrase('data_deleted'));
            redirect(site_url('admin/categories'), 'refresh');
        }
    ...
    public function instructors($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','instructors','add_instructor','add',"true",'user_model',null,'creates a new instructor account','successful',['text'=>'attempts to create a new instructor account']);
            redirect(site_url('admin/instructors'), 'refresh');
        } elseif ($param1 == "edit") {
            $this->user_model->edit_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','instructors','delete_instructor','edit',"$param2",'user_model',null,'edit existing instructor account','successful',['text'=>'attempts to edit instructor account']);
            redirect(site_url('admin/instructors'), 'refresh');
        } elseif ($param1 == "delete") {
            $this->user_model->delete_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','instructors','delete_instructor','delete',"$param2",'user_model',null,'deletes existing instructor account','successful',['text'=>'attempts to delete instructor account']);
            redirect(site_url('admin/instructors'), 'refresh');
        }
    ...
    public function users($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','users','add_user','add_user',null,'user_model',null,'creates user account','successful',['text'=>'attempts to create a new user']);
            redirect(site_url('admin/users'), 'refresh');
        } elseif ($param1 == "edit") {
            $this->user_model->edit_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','users','edit_user','edit_user',"$param2",'user_model',null,'edit user account','successful',['text'=>'attempts to edit user']);
            redirect(site_url('admin/users'), 'refresh');
        } elseif ($param1 == "delete") {
            $this->user_model->delete_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','users','delete_user','delete_user',"$param2",'user_model',null,'delete user','successful',['text'=>'attempts to delete user']);
            redirect(site_url('admin/users'), 'refresh');
        }
        ...
        foreach ($students as $key => $student) :
            ...
            $action = '<div class="dropright dropright">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="d-none"><a class="dropdown-item" href="javascript:void(0);" onclick="showLargeModal(' ."'". site_url('modal/popup/user_info_modal/' . $student['id']) ."','user info'".')">' . get_phrase('info') . '</a></li>
                                <li><a target="_blank" class="dropdown-item" href="' . site_url('admin/user_profile/' . $student['id']) . '">' . get_phrase('profile') . '</a></li>
                                <li><a class="dropdown-item" href="javascript:void(0);" onclick="showAjaxModal(' ."'". site_url('modal/popup/mail_user_modal/' . $student['id']) ."','send mail'".')">' . get_phrase('mail') . '</a></li>
        ...
        foreach ($instructors as $key => $instructor) :
            ...
            $action = '<div class="dropright dropright">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a target="_blank" class="dropdown-item" href="' . site_url('admin/user_profile/' . $instructor['id']) . '">' . get_phrase('profile') . '</a></li>
                                <li><a class="dropdown-item" href="javascript:void(0);" onclick="showAjaxModal(' ."'". site_url('modal/popup/mail_user_modal/' . $instructor['id']) ."','send mail'".')">' . get_phrase('mail') . '</a></li>
    ...
    public function add_shortcut_student()
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','add_shortcut_student','add_shortcut_user','add_shortcut_user',"$is_instructor",'user_model',null,'add shortcut user','successful',['text'=>'attempts to create user via shortcut form']);
    }
    ...
    public function enrol_history($param1 = "")
    {
        ...
        if ($param1 != "") {
            ...
            $first_day_of_month = '1 Jan 2000 00:00:00';
            //$last_day_of_month = date("t") . " " . date("M") . " " . date("Y") . ' 23:59:59';
            $last_day_of_month=date('d M Y H:i:s',time()+86400);
    ...
    public function enrol_student($param1 = "")
    {
        ...
        if ($param1 == 'enrol') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','enrol_student','enroll_a_student_manually','enrol_a_student_manually',null,'crud_model',null,'enrol student manually','successful',['text'=>'attempts to enroll student manually']);
    ...
    public function shortcut_enrol_student()
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','shortcut_enrol_student','shortcut_enroll_a_student_manually','shortcut_enrol_a_student_manually',null,'crud_model',null,'shortcut enrol a student manually','successful',['text'=>'attempts to enroll student via shotcut']);
    }
    ...
    public function enrol_history_delete($param1 = "")
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','enrol_history_delete','delete_enrol_history','delete_enrol_history',"$param1",'crud_model',"data_deleted_successfully",'delete enrol history','successful',['text'=>'attempts to delete enrol history']);
    ...
    public function system_settings($param1 = "")
    {
        ...
        if ($param1 == 'system_update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','system_settings','system_update','update_system_settings',null,'crud_model',"system_settings_updated",'updates system settings','successful',['text'=>'attempts to update system settings']);
        ...
        if ($param1 == 'logo_upload') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'system_settings',"move_uploaded_file",'admin','logo_upload','updates system logo','successful',['text'=>'attempts to update system logo']);
        ...
        if ($param1 == 'favicon_upload') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'system_settings',"move_uploaded_file",'admin','favicon_upload','updates system favicon','successful',['text'=>'attempts to update system favicon']);
    ...
    public function frontend_settings($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'frontend_update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','frontend_update','update_frontend_settings',null,'crud_model',"frontend_settings_updated",'updates frontend settings','successful',['text'=>'attempts to update frontend settings']);
        ...
        if ($param1 == 'recaptcha_update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','recaptha_update','update_recaptha_settings',null,'crud_model',"recaptcha_settings_updated",'updates recaptha settings','successful',['text'=>'attempts to update recaptha settings']);
        ...
        if ($param1 == 'banner_image_update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','banner_image_update','update_frontend_banner',null,'crud_model',"banner_image_update",'updates banner_image','successful',['text'=>'attempts to update banner_image']);
        ...
        if ($param1 == 'light_logo') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','light_logo','update_light_logo',null,'crud_model',"logo_updated",'updates light_logo','successful',['text'=>'attempts to update light_logo']);
            $this->session->set_flashdata('flash_message', get_phrase('logo_updated'));
            redirect(site_url('admin/frontend_settings?tab=logo_and_images'), 'refresh');
        }
        if ($param1 == 'dark_logo') {
            $this->crud_model->update_dark_logo();
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','dark_logo','update_dark_logo',null,'crud_model',"logo_updated",'updates dark_logo','successful',['text'=>'attempts to update dark_logo']);
            $this->session->set_flashdata('flash_message', get_phrase('logo_updated'));
            redirect(site_url('admin/frontend_settings?tab=logo_and_images'), 'refresh');
        }
        if ($param1 == 'small_logo') {
            $this->crud_model->update_small_logo();
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','small_logo','update_small_logo',null,'crud_model',"logo_updated",'updates small_logo','successful',['text'=>'attempts to update small_logo']);
            $this->session->set_flashdata('flash_message', get_phrase('logo_updated'));
            redirect(site_url('admin/frontend_settings?tab=logo_and_images'), 'refresh');
        }
        if ($param1 == 'favicon') {
            $this->crud_model->update_favicon();
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','favicon','update_favicon',null,'crud_model',"favicon_updated",'updates favicon','successful',['text'=>'attempts to update favicon']);
            $this->session->set_flashdata('flash_message', get_phrase('favicon_updated'));
            redirect(site_url('admin/frontend_settings?tab=logo_and_images'), 'refresh');
        }
        ...
        if ($param1 == 'motivational_speech') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','motivational_speech','update_motivational_speech',null,'crud_model',"Motivational speech updated successfully",'updates motivational speech','successful',['text'=>'attempts to update motivational speech']);
        ...
        if ($param1 == 'website_faq') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','website_faq','update_website_faq',null,'crud_model',"Website FAQS updated successfully",'updates website faq','successful',['text'=>'attempts to update website faq']);
        ...
        if ($param1 == 'contact_info') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','contact_info','update_contact_info',null,'crud_model',"Contact information updated successfully",'updates contact info','successful',['text'=>'attempts to update contact info']);
        ...
        if ($param1 == 'custom_codes') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','custom_codes','update_custom_codes',null,'crud_model',"Your custom codes updated successfully",'updates custom codes','successful',['text'=>'attempts to update custom codes']);
        ...
        if ($param1 == 'home_page_settings') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','homepage_settings','update_homepage_settings',"$param2",'crud_model',"settings updated successfully",'updates homepage settings','successful',['text'=>'attempts to update homepage settings']);
        ...
        if ($param1 == 'water_mark') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','frontend_settings','water_mark','update_water_mark',null,'crud_model',"video water marks updated successfully",'updates water mark','successful',['text'=>'attempts to update water mark']);
    ...
    public function payment_settings($param1 = "")
    {
        ...
        if ($param1 == 'system_currency') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','payment_settings','system_currency','update_system_currency',null,'crud_model',null,'updates system currency','successful',['text'=>'attempts to update system currency']);
            redirect(site_url('admin/payment_settings'), 'refresh');
        }

        if (isset($_POST['identifier'])) {
            $this->crud_model->update_payment_settings();
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','payment_settings','payment_settings','update_payment_settings',null,'crud_model',null,'updates payment settings','successful',['text'=>'attempts to update payment settings']);
            redirect(site_url('admin/payment_settings'), 'refresh');
        }
    ...
    public function notification_settings($param1 = "", $param2 = "", $param3 = "")
    {
        if ($param1 == 'smtp_settings') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','notification_settings','smtp_settings','update_smtp_settings',null,'crud_model',"smtp_settings_updated_successfully",'updates smtp settings','successful',['text'=>'attempts to update smtp settings']);
        ...
        if ($param1 == 'notification_enable_diable') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','notification_settings','notification_enable_diable','notification_enable_diable',null,'crud_model',null,'attempts to enable/disable notification','successful',json_encode(['text'=>'enable/disable notification']));
            return;
        }
    ...
    function edit_email_template($id = "", $param2 = "")
    {
        ...
        if ($param2 == 'update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','edit_email_template','update','update_notification_settings',"notification_settings,id,$id",'db',"Email template updated successfully",'updates notification settings','successful',['text'=>'attempts to update notification settings']);
    ...
    public function social_login_settings($param1 = "")
    {
        ...
        if ($param1 == 'update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','social_login_settings','social_login_settings','update_social_login_settings',null,'crud_model',"social_login_settings_updated_successfully",'updates update social login settings','successful',['text'=>'attempts to update update social login settings']);
    ...
    public function instructor_settings($param1 = "")
    {
        ...
        if ($param1 == 'update') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','instructor_settings','instructor_settings','update_instructor_settings',null,'crud_model',"instructor_settings_updated",'updates instructor settings','successful',['text'=>'attempts to update instructor settings']);
    ...
    public function theme_actions($action = "", $theme = "")
    {
        ...
        if ($action == 'activate') {
            ...
            if ($theme == get_frontend_settings('theme')) {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,null,'admin','remove','remove files and folders','failed',['text'=>'attempts to remove theme files and folders']);
    ...
    public function course_actions($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','course_actions','add','add_course',null,'crud_model',null,'add course','successful',['text'=>'attempts to add course']);
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','course_actions','add_shortcut','add_shortcut_course',null,'crud_model',null,'add shortcut course','successful',['text'=>'attempts to add shortcut course']);
        } elseif ($param1 == "edit") {

            $this->crud_model->update_course($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','course_actions','edit','update_course',"$param2",'crud_model',null,'update course','successful',['text'=>'attempts to update course']);
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','course_actions','delete','delete_course',"$param2",'crud_model',null,'delete course','successful',['text'=>'attempts to delete course']);
    ...
    public function course_form($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add_course') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','course_form','course_duplicate','duplicate_course',"$param2",null,"Course Duplicate Successfully",'duplicate course','successful',['text'=>'attempts to duplicate course']);
    ...
    public function duplicate_course($id){
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','duplicate_course','duplicate_course','insert',"course",'db',null,'duplicate course','successful',['text'=>'attempts to duplicate course']);
    }
    ...
    public function change_course_status($updated_status = "")
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','change_course_status','change_course_status','change_course_status',"$updated_status, $course_id",'crud_model',"course_status_updated",'change course status','successful',['text'=>'attempts to change course status']);
    ...
    public function change_course_status_for_admin($updated_status = "", $course_id = "", $category_id = "", $status = "", $instructor_id = "", $price = "")
    {
        ...
        $this->crud_model->change_course_status($updated_status, $course_id);
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','change_course_status_for_admin','change_course_status','change_course_status',"$updated_status, $course_id",'crud_model',"course_status_updated",'change course status of admin owned course','successful',['text'=>'attempts to change course status of admin owned course']);
        $this->session->set_flashdata('flash_message', get_phrase('course_status_updated'));
        redirect(site_url('admin/courses?category_id=' . $category_id . '&status=' . $status . '&instructor_id=' . $instructor_id . '&price=' . $price), 'refresh');
    }
    ...
    public function sections($param1 = "", $param2 = "", $param3 = "")
    {
        ...
        if ($param2 == 'add') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','sections','add','add_section',"$param1",'crud_model',"section_has_been_added_successfully",'add section','successful',['text'=>'attempts to add section']);
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','sections','edit','edit_section',"$param3",'crud_model',"section_has_been_updated_successfully",'edit section','successful',['text'=>'attempts to edit section']);
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','sections','delete','delete_section',"$param1,$param3",'crud_model',"section_has_been_deleted_successfully",'delete section','successful',['text'=>'attempts to delete section']);
    ...
    public function lessons($course_id = "", $param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add') {
            ...
            echo $response;
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','lessons','add','add_lesson',null,'crud_model',null,'add lesson','successful',['text'=>'attempts to add lesson']);
            return;
        } elseif ($param1 == 'edit') {
            $response = $this->crud_model->edit_lesson($param2);
            echo $response;
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','lessons','edit','edit_lesson',"$param2",'crud_model',null,'edit lesson','successful',['text'=>'attempts to edit lesson']);
            return;
        } elseif ($param1 == 'delete') {
            $this->crud_model->delete_lesson($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','lessons','delete','delete_lesson',"$param2",'crud_model',"lesson_has_been_deleted_successfully",'delete lesson','successful',['text'=>'attempts to delete lesson']);
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'send_new') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','message','send_new','send_new_private_message',null,'crud_model',"message_sent",'send new private message','successful',['text'=>'attempts to send new private message']);
        ...
        if ($param1 == 'send_reply') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','message','send_reply','send_reply_message',"$param2",'crud_model',"message_sent",'send reply for a private message','successful',['text'=>'attempts to send reply for a private message']);
            $this->session->set_flashdata('flash_message', get_phrase('message_sent'));
        ...
        if ($param1 == 'message_read') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','message','message','mark_thread_messages_read',"$param2",'crud_model',null,'mark thread messages as read','successful',['text'=>'attempts to mark thread messages as read']);
        }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            $this->user_model->edit_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','manage_profile','update_profile_info','edit_user',"$param2",'user_model',null,'update own profile info','successful',['text'=>'attempts to update own profile info']);
            redirect(site_url('admin/manage_profile'), 'refresh');
        }
        if ($param1 == 'change_password') {
            $this->user_model->change_password($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','manage_profile','change_password','change_password',"$param2",'user_model',null,'change own password','successful',['text'=>'attempts to change own password']);
            redirect(site_url('admin/manage_profile'), 'refresh');
        }
    ...
    public function paypal_payment($payout_id = "", $paypalPaymentID = "", $paypalPaymentToken = "", $paypalPayerID = "")
    {
        ...
        if (!$status) {
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'paypal_payment','update_payout_status','admin',"$status",'confirm paypal payment','failed',['text'=>'attempts to confirm paypal payment']);
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'paypal_payment','update_payout_status','admin',"$status",'confirm paypal payment','successful',['text'=>'attempts to confirm paypal payment']);
    ...
    public function quizes($course_id = "", $action = "", $quiz_id = "")
    {
        ...
        if ($action == 'add') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','quizes','add','add_quiz',"$course_id",'crud_model',"quiz_has_been_added_successfully",'add quiz','successful',['text'=>'attempts to add quiz']);
            $this->session->set_flashdata('flash_message', get_phrase('quiz_has_been_added_successfully'));
        } elseif ($action == 'edit') {
            $this->crud_model->edit_quiz($quiz_id);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','quizes','edit','edit_quiz',"$quiz_id",'crud_model',"quiz_has_been_updated_successfully",'edit quiz','successful',['text'=>'attempts to edit quiz']);
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','quizes','delete','delete_section',"$course_id,$quiz_id",'crud_model',"quiz_has_been_deleted_successfully",'delete quiz or section','successful',['text'=>'attempts to delete quiz or section']);
    ...
    public function quiz_questions($quiz_id = "", $action = "", $question_id = "")
    {
        ...
        if ($action == 'add' || $action == 'edit') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','quiz_questions','add_edit','manage_quiz_question',"$quiz_id, $question_id, $action",'crud_model',null,'add or edit quiz question','successful',['text'=>'attempts to add or edit quiz question']);
        } elseif ($action == 'delete') {
            $response = $this->crud_model->delete_quiz_question($question_id);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','quiz_question','delete','delete_quiz_question',"$question_id",'crud_model',"question_has_been_deleted",'delete quiz question','successful',['text'=>'attempts to delete quiz question']);
    ...
    { // param1 is the status and param2 is the application id
        ...
        if ($param1 == 'approve' || $param1 == 'delete') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','instructor_application','approve_delete','instructor_application',"$param1, $param2",'user_model',null,'approve or delete instructor application','successful',['text'=>'attempts to approve or delete instructor application']);
    ...
    public function admins($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            $this->user_model->add_user(false, true); // PROVIDING TRUE FOR ADMIN AND FALSE FOR INSRUCTOR
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','admins','add','add_user',"false, true",'user_model',null,'add admin','successful',['text'=>'attempts to add admin']);

            redirect(site_url('admin/admins'), 'refresh');
        } elseif ($param1 == "edit") {
            // CHECK ACCESS PERMISSION
            check_permission('admin');
            if(!is_root_admin() && is_root_admin($param2)) {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','admins','edit','edit_user',"$param2",'user_model',"root_admin_can_not_be_modified",'edit admin','failed',['text'=>'attempts to edit admin']);
                $this->session->set_flashdata('error_message', get_phrase('root_admin_can_not_be_modified'));
                redirect(site_url('admin/admins'), 'refresh');
            }

            $this->user_model->edit_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','admins','edit','edit_user',"$param2",'user_model',null,'edit admin','successful',['text'=>'attempts to edit admin']);
            redirect(site_url('admin/admins'), 'refresh');
        } elseif ($param1 == "delete") {
            // CHECK ACCESS PERMISSION
            check_permission('admin');
            if(is_root_admin($param2)) {
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','admins','delete','delete_user',"$param2",'user_model',"root_admin_can_not_be_removed",'delete admin','failed',['text'=>'attempts to delete admin']);
                $this->session->set_flashdata('error_message', get_phrase('root_admin_can_not_be_removed'));
                redirect(site_url('admin/admins'), 'refresh');
            }

            $this->user_model->delete_user($param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','admins','delete','delete_user',"$param2",'user_model',null,'delete admin','successful',['text'=>'attempts to delete admin']);
            redirect(site_url('admin/admins'), 'refresh');
        }
    ...
    public function assign_permission()
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','assign_permission','assign_permission','assign_permission',null,'user_model',null,'assign permission','successful',['text'=>'attempts to assign permission']);
            ...
            if (in_array($instructor_id, $instructor_ids)) {
                if (count($instructor_ids) > 1) {
                    if (($key = array_search($instructor_id, $instructor_ids)) !== false) {
                        ...
                        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','remove_an_instructor','remove_an_instructor','update',"course",'db',"instructor_has_been_removed",'remove an instructor','successful',['text'=>'attempts to remove an instructor']);
                    ...
                    $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','remove_an_instructor','remove_an_instructor','update',"course",'db',"a_course_should_have_at_least_one_instructor",'remove an instructor','failed',['text'=>'attempts to remove an instructor']);
    ...
    public function ajax_sort_section()
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','ajax_sort_section','ajax_sort_section','sort_section',"$section_json",'crud_model',null,'ajax sort section','successful',['text'=>'attempts to ajax sort section']);
    }
    public function ajax_sort_lesson()
    {
        $lesson_json = $this->input->post('itemJSON');
        $this->crud_model->sort_lesson($lesson_json);
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','ajax_sort_lesson','ajax_sort_lesson','sort_lesson',"$lesson_json",'crud_model',null,'ajax sort lesson','successful',['text'=>'attempts to ajax sort lesson']);
    }
    public function ajax_sort_question()
    {
        $question_json = $this->input->post('itemJSON');
        $this->crud_model->sort_question($question_json);
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','ajax_sort_question','ajax_sort_question','sort_question',"$question_json",'crud_model',null,'ajax sort question','successful',['text'=>'attempts to ajax sort question']);
    }
    ...
    function delete_course_review($rating_id = "")
    {
        ...
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','delete_course_review','delete_course_review','delete',"rating,id,$rating_id",'db',"user_review_deleted_successfully",'delete course review','successful',['text'=>'attempts to delete course review']);
    ...
    function get_my_notification($type = "")
    {
        ...
        if ($type == 'mark_all_as_read') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','get_my_notification','mark_all_as_read','update',"notifications",'db',null,'mark all notification as read','successful',['text'=>'attempts to mark all notification as read']);
        }

        if ($type == 'remove_all') {
            $this->db->where('to_user', $user_id);
            $this->db->delete('notifications');
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','get_my_notification','remove_all','delete',"notifications,to_user,$user_id",'db',null,'remove all notification','successful',['text'=>'attempts to remove all notification']);
        }
    ...
    function subscribed_user($type = "", $id = "")
    {
        ...
        if ($_POST) {
            ...
            if (empty($search)) {
                ...
                $filtered_number_of_row = count((array)$newsletter_subscriber);
            }
    ...
    function newsletter_history($type = "", $id = "")
    {
        ...
        if ($_POST) {
            ...
            if (empty($search)) {
                ...
                $filtered_number_of_row = count((array)$newsletter_histories);
            }
    ...
    function contact($type = "", $id = "")
    {
        if ($type == 'delete') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','contact','delete','delete',"contact,id,$id",'db',"Contact deleted successfully",'delete contact','successful',['text'=>'attempts to delete contact']);
        ...
        if ($type == 'send_reply' && $id != '') {
            ...
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','contact','send_reply','send_smtp_mail',"contact,$id,['replied' => 1]",'db',"Reply sent successfully",'send reply to contact','successful',['text'=>'attempts to send reply to contact']);
    ...
    function change_course_author($course_id = ""){
        if(isset($_POST) && count($_POST) > 0){
            if($_POST['instructor_id'] > 0){
                ...
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','change_course_author','change_course_author','update',"course,$course_id,creator",'db',"Course author changed successfully",'change course author','successful',['text'=>'attempts to change course author']);
                $this->session->set_flashdata('flash_message', get_phrase("Course author changed successfully"));
            }else{
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','change_course_author','change_course_author','update',"course,$course_id,creator",'db',"Something is wrong",'change course author','failed',['text'=>'attempts to change course author']);
    ...
    function add_users_from_csv(){
        ...
        $resp=$this->user_model->add_users_from_csv();
        $this->session->set_flashdata('flash_message', "{$resp['success']}/{$resp['total']} new users created");
        redirect(site_url('admin/users'), 'refresh');
    }

    public function enrol_students_from_csv($param1 = "")
    {
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        $resp=$this->crud_model->enrol_students_from_csv();
        $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','enrol_students_from_csv','enrol_students_from_csv','enrol_students_from_csv',null,'crud_model',"{$resp['success']}/{$resp['total']} students enrolled",'enrol students from csv','successful',['text'=>'attempts to enrol students from csv']);
        $this->session->set_flashdata('flash_message', "{$resp['success']}/{$resp['total']} students enrolled");
        redirect(site_url('admin/enrol_history'), 'refresh');
    }
    ...
    function live_schedule($param=null,$param_id=0,$param_filter=false){
        ...
        if($param){
            check_permission('schedule');

            if ($param == "add") {
                $schedule_id=$this->crud_model->add_live_schedule();
                if($schedule_id) $this->crud_model->add_live_schedule_user($schedule_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','live_schedule','add','add_live_schedule',null,'crud_model',null,'add live schedule','successful',['text'=>'attempts to add live schedule']);
                redirect(site_url('admin/live_schedule'), 'refresh');
            }
            if ($param == "add_user") {
                $this->crud_model->add_live_schedule_user($param_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','live_schedule','add_user','add_live_schedule_user',"$param_id",'crud_model',null,'add live schedule user','successful',['text'=>'attempts to add live schedule user']);
                redirect(site_url('admin/live_schedule'), 'refresh');
            }
            if ($param == "delete_user_api") {
                echo json_encode($this->crud_model->delete_live_schedule_user_api($param_id));
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','live_schedule','delete_user_api','delete_live_schedule_user_api',"$param_id",'crud_model',null,'delete live schedule user','successful',['text'=>'attempts to delete live schedule user']);
                exit;
                //redirect(site_url('admin/live_schedule'), 'refresh');
            }
            if ($param == "update" && $param_id) {
                $this->crud_model->update_live_schedule($param_id,null,$param_filter);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','live_schedule','update','update_live_schedule',"$param_id,null,$param_filter",'crud_model',null,'update live schedule','successful',['text'=>'attempts to update live schedule']);
                redirect(site_url('admin/live_schedule'), 'refresh');
            }
            if ($param == "cancel" && $param_id) {
                $this->crud_model->update_live_schedule($param_id,0,$param_filter);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','live_schedule','cancel','update_live_schedule',"$param_id,0,$param_filter",'crud_model',null,'cancel live schedule','successful',['text'=>'attempts to cancel live schedule']);
                redirect(site_url('admin/live_schedule'), 'refresh');
            }
            if ($param == "delete" && $param_id) {
                $this->crud_model->delete_live_schedule($param_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','live_schedule','delete','delete_live_schedule',"$param_id",'crud_model',null,'delete live schedule','successful',['text'=>'attempts to delete live schedule']);
                redirect(site_url('admin/live_schedule'), 'refresh');
            }
        }
        ...
        $page_data['live_schedules'] = $this->crud_model->fetch_live_schedule(null,0,$param_id);
        $page_data['upcoming_live_schedules'] = $this->crud_model->fetch_live_schedule(true,0,$param_id,$time);
        $page_data['ongoing_live_schedules'] = $this->crud_model->fetch_live_schedule(true,0,$param_id,$time,0,$time);
        $page_data['elapsed_live_schedules'] = $this->crud_model->fetch_live_schedule(null,0,$param_id,0,0,$time);
    ...
    function activity_log(){
        ...
        $page_data['controller']                   = $this->input->post('controller');
        $page_data['function']                   = $this->input->post('function');
        $page_data['action']                   = $this->input->post('action');
        ...
        $created_1=date('Y-m-d',$page_data['timestamp_start']);
        $created_2=date('Y-m-d',$page_data['timestamp_end']);

        $page_data['page_name'] = 'activity_log';
        $page_data['page_title'] = get_phrase('activity_logs');
        $page_data['activity_log'] = $this->crud_model->fetch_activity_log(array('user_id'=>$page_data['user_id'],'controller'=>$page_data['controller'],'function'=>$page_data['function'],'action'=>$page_data['action'],'created_1'=>$created_1,'created_2'=>$created_2,'order_by'=>'id'));
        $this->load->view('backend/index', $page_data);
    }

    function key_activity_log($param=null,$param_id=0){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        $date_range                   = $this->input->post('date_range');
        $page_data['activity']                   = $this->input->post('activity');
        $page_data['to_user']                   = $this->input->post('to_user');
        $page_data['user_id']                   = $this->input->post('user_id');
        if ($date_range != "") {
            $date_range                   = explode(" - ", $date_range);
            $page_data['timestamp_start'] = strtotime($date_range[0] . ' 00:00:00');
        ...
        if ($param == "add") {
            $this->crud_model->add_key_activity_log();
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','key_activity_log','add','add_key_activity_log',null,'crud_model',null,'add key activity log','successful',['text'=>'attempts to add key activity log']);
            redirect(site_url('admin/key_activity_log'), 'refresh');
        }
        if ($param == "update" && $param_id) {
            $this->crud_model->update_key_activity_log($param_id);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','key_activity_log','update','update_key_activity_log',"$param_id",'crud_model',null,'update key activity log','successful',['text'=>'attempts to update key activity log']);
            redirect(site_url('admin/key_activity_log'), 'refresh');
        }
        if ($param == "delete" && $param_id) {
            $this->crud_model->delete_key_activity_log($param_id);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','key_activity_log','delete','delete_key_activity_log',"$param_id",'crud_model',null,'delete key activity log','successful',['text'=>'attempts to delete key activity log']);
            redirect(site_url('admin/key_activity_log'), 'refresh');
        }
        if ($param == "delete_api" && $param_id) {
            echo json_encode($this->crud_model->delete_key_activity_log($param_id));
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','key_activity_log','delete','delete_key_activity_log',"$param_id",'crud_model',null,'delete key activity log','successful',['text'=>'attempts to delete key activity log']);
            exit;
        }

        $page_data['page_name'] = 'key_activity_log';
        $page_data['page_title'] = get_phrase('manage_key_activities');
        $page_data['key_activity_log'] = $this->crud_model->fetch_key_activity_log(array('user_id'=>$page_data['user_id'],'to_user'=>$page_data['to_user'],'activity'=>$page_data['activity'],'created_1'=>$created_1,'created_2'=>$created_2,'order_by'=>'id'));
        $this->load->view('backend/index', $page_data);
    }
    ...
    function user_profile($user_id){
        ...
        $page_data['page_title'] = get_phrase('User profile');
        $this->load->view('backend/index', $page_data);
    }

    function mail_user($user_id,$page='users'){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        if($user_id) {
            $this->user_model->mail_user($user_id);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','mail_user',null,'mail_user',"$user_id",'user_model',null,'mail user','success',['text'=>'attempts to mail user']);
        }
        redirect(site_url("admin/$page"), 'refresh');
    }

    public function courses_qa($param1=null)
    {
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        // CHECK ACCESS PERMISSION
        if (!(has_permission('iqa')||has_permission('eqa')||has_permission('course'))) {
            $this->session->set_flashdata('error_message', get_phrase('you_are_not_authorized_to_access_this_page'));
        ...
        // Filter portion
        $category_id   = $this->input->get('selected_category_id');
        $instructor_id = $this->input->get('selected_instructor_id');
        $price         = $this->input->get('selected_price');
        $status        = $this->input->get('selected_status');
        $status='active';
        ...
        if($param1=='update_api'){
            check_permission('course');
            echo json_encode($this->crud_model->update_qa_courses());
            return;
        }
        ...
        $page_data['selected_category_id']   = $category_id ? $category_id : "all";
        $page_data['selected_instructor_id'] = $instructor_id ? $instructor_id : "all";
        $page_data['selected_price']         = $price ? $price : "all";
        $page_data['selected_status']        = $status ? $status : "all";


        $page_data['courses']              = $courses;
        $page_data['total_number_of_row']  = $total_number_of_row;

        $page_data['page_name']              = 'courses_qa';
        $page_data['categories']             = $this->crud_model->get_categories();
        $page_data['instructors'] = $this->user_model->get_instructor()->result_array();
        $page_data['page_title']             = get_phrase('active_courses');
        $this->load->view('backend/index', $page_data);
    ...
    function academic_progress_qa($course_id){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }

        if(!$course_id) $course_id=$this->input->get('course_id');
        ...
        $course_details = $this->crud_model->get_course_by_id($course_id)->row_array();
        $page_data['page_name'] = 'academic_progress_qa';
        $page_data['course_id'] = $course_id;
        $page_data['limit'] = $limit;
        $page_data['offset'] = $offset;
        $page_data['courses']=$this->db->get_where('course',array('creator'=>$course_details['creator']))->result_array();
        $page_data['page_title'] = get_phrase('academic_progress');
        $this->load->view('backend/index', $page_data);
    }

    function report_qa($param=null,$param_id=0){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }

        // CHECK ACCESS PERMISSION
        if (!(has_permission('iqa')||has_permission('eqa'))) {
            $this->session->set_flashdata('error_message', get_phrase('you_are_not_authorized_to_access_this_page'));
            redirect(site_url('admin/dashboard'), 'refresh');
        }
        ...
        if ($param) {
            //check_permission('iqa');

            if ($param == "add") {
                $this->crud_model->add_report_qa();
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','report_qa','add','add_report_qa',null,'crud_model',null,'add report qa','successful',['text'=>'attempts to add report qa']);
                redirect(site_url('admin/report_qa'), 'refresh');
            }
            if ($param == "update" && $param_id) {
                $this->crud_model->update_report_qa($param_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','report_qa','update','update_report_qa',"$param_id",'crud_model',null,'update report qa','successful',['text'=>'attempts to update report qa']);
                redirect(site_url('admin/report_qa'), 'refresh');
            }
            if ($param == "delete" && $param_id) {
                $this->crud_model->delete_report_qa($param_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','report_qa','delete','delete_report_qa',"$param_id",'crud_model',null,'delete report qa','successful',['text'=>'attempts to delete report qa']);
                redirect(site_url('admin/report_qa'), 'refresh');
            }
            if ($param == "delete_api" && $param_id) {
                echo json_encode($this->crud_model->delete_report_qa($param_id));
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','report_qa','delete','delete_report_qa',"$param_id",'crud_model',null,'delete report qa','successful',['text'=>'attempts to delete report qa']);
                exit;
            }
        }

        $page_data['page_name'] = 'report_qa';
        $page_data['page_title'] = get_phrase('manage_reports'.' QA');
        $page_data['report_qa'] = $this->crud_model->fetch_report_qa(array('user_id'=>$page_data['user_id'],'to_user'=>$page_data['to_user'],'title'=>$page_data['title'],'created_1'=>$created_1,'created_2'=>$created_2,'order_by'=>'id'));
        $this->load->view('backend/index', $page_data);
    }

    function review_qa($param=null,$param_id=0){
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        if ($param) {
            ...
            if ($param == "add") {
                $this->crud_model->add_review_qa();
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','review_qa','add','add_review_qa',null,'crud_model',null,'add review qa','successful',['text'=>'attempts to add review qa']);
                redirect(site_url("admin/user_profile/{$page_data['to_user']}"), 'refresh');
            }
            if ($param == "update" && $param_id) {
                $this->crud_model->update_review_qa($param_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','review_qa','update','update_review_qa',"$param_id",'crud_model',null,'update review qa','successful',['text'=>'attempts to update review qa']);
                redirect(site_url("admin/user_profile/{$page_data['to_user']}"), 'refresh');
            }
            if ($param == "delete" && $param_id) {
                $this->crud_model->delete_review_qa($param_id);
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','review_qa','delete','delete_review_qa',"$param_id",'crud_model',null,'delete review qa','successful',['text'=>'attempts to delete review qa']);
                redirect(site_url("admin/user_profile/{$page_data['to_user']}"), 'refresh');
            }
            if ($param == "delete_api" && $param_id) {
                echo json_encode($this->crud_model->delete_review_qa($param_id));
                $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','review_qa','delete','delete_review_qa',"$param_id",'crud_model',null,'delete review qa','successful',['text'=>'attempts to delete review qa']);
                exit;
            }
        }

        $page_data['page_name'] = 'review_qa';
        $page_data['page_title'] = get_phrase('manage_reviews'.' QA');
        $page_data['review_qa'] = $this->crud_model->fetch_review_qa(array('user_id'=>$page_data['user_id'],'to_user'=>$page_data['to_user'],'title'=>$page_data['title'],'created_1'=>$created_1,'created_2'=>$created_2,'order_by'=>'id'));
        $this->load->view('backend/index', $page_data);
    }

    function student_academic_progress_qa($course_id = "",$limit=25,$offset=0)
    {
        $course_details = $this->crud_model->get_course_by_id($course_id)->row_array();
        $multi_instructors = explode(',', $course_details['user_id']);
        ...
        $page_data['offset']=$offset;
        $page_data['course_details'] = $course_details;
        $this->load->view('backend/admin/student_academic_progress_qa', $page_data);
    }

    function rating($param=null,$param1=null,$param2=null){
        $ratings = $this->crud_model->get_rating_by_status()->result_array();
        if ($param=='update_status_api') {
            $resp=$this->crud_model->update_rating_status($param1,(int)$param2);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','rating',$param1,'update_rating_status',"$param1,$param2",'crud_model',null,'update rating status','successful',['text'=>'attempts to update rating status']);
            echo json_encode($resp);
            return;
        }
        if ($param=='delete_api') {
            $resp=$this->crud_model->delete_rating((int)$param1);
            $this->crud_model->add_activity_log($this->session->userdata('user_id'),1,'admin','rating',$param1,'delete_rating',"$param1",'crud_model',null,'deletss rating','successful',['text'=>'attempts to delete rating']);
            echo json_encode($resp);
            return;
        }
        $page_data['page_name'] = 'rating';
        $page_data['page_title'] = get_phrase('rating');
